...
import os
import time
import yoloall.utils as utils
from yoloall.trackers import Tracker
from yoloall.detectors import Detector
from yoloall.utils.default_cfg import config
import numpy as np
...
class YOLOAll:
    def __init__(self,
        ...
        # get detector object
        self.detector = self.get_detector(detector, weights, num_classes)
    ...
    def get_detector(self, detector: int, weights: str, num_classes):
        detector = Detector(detector, weights=weights,
                            use_cuda=self.use_cuda, num_classes=num_classes).get_detector()
        return detector
...
if __name__ == '__main__':
    ...
    yoloall.start_tracking('data/videos/test_traffic.mp4',
